 ...
 * </p>
 */
public class NumberPickerD extends LinearLayout {
    ...
    public interface OnValueChangeListener {
         ...
         */
        void onValueChange(NumberPickerD picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *                    {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(NumberPickerD view, @ScrollState int scrollState);
    }
     ...
     */
    public NumberPickerD(Context context) {
        this(context, null);
    }
     ...
     */
    public NumberPickerD(Context context, AttributeSet attrs) {
     ...
     */
    public NumberPickerD(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        // process style attributes
        final TypedArray attributesArray = context.obtainStyledAttributes(
                attrs, R.styleable.NumberPickerD);
        final int layoutResId = attributesArray.getResourceId(
                R.styleable.NumberPickerD_internalLayout, DEFAULT_LAYOUT_RESOURCE_ID);

        mHasSelectorWheel = (layoutResId != DEFAULT_LAYOUT_RESOURCE_ID);

        mHideWheelUntilFocused = attributesArray.getBoolean(
                R.styleable.NumberPickerD_hideWheelUntilFocused, false);

        mSolidColor = attributesArray.getColor(R.styleable.NumberPickerD_solidColor, 0);

        final Drawable selectionDivider = attributesArray.getDrawable(
                R.styleable.NumberPickerD_selectionDivider);
        ...
        mSelectionDividerHeight = attributesArray.getDimensionPixelSize(
                R.styleable.NumberPickerD_selectionDividerHeight, defSelectionDividerHeight);
        ...
        mSelectionDividersDistance = attributesArray.getDimensionPixelSize(
                R.styleable.NumberPickerD_selectionDividersDistance, defSelectionDividerDistance);

        mMinHeight = attributesArray.getDimensionPixelSize(
                R.styleable.NumberPickerD_internalMinHeight, SIZE_UNSPECIFIED);

        mMaxHeight = attributesArray.getDimensionPixelSize(
                R.styleable.NumberPickerD_internalMaxHeight, SIZE_UNSPECIFIED);
        ...
        mMinWidth = attributesArray.getDimensionPixelSize(
                R.styleable.NumberPickerD_internalMinWidth, SIZE_UNSPECIFIED);

        mMaxWidth = attributesArray.getDimensionPixelSize(
                R.styleable.NumberPickerD_internalMaxWidth, SIZE_UNSPECIFIED);
        ...
        mVirtualButtonPressedDrawable = attributesArray.getDrawable(
                R.styleable.NumberPickerD_virtualButtonPressedDrawable);
    ...
    public NumberPickerD(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    // delete dispatchHoverEvent() here
...
//        }
    ...
    class PressedStateHelper implements Runnable {
        ...
        public void buttonPressDelayed(int button) {
            ...
            NumberPickerD.this.postDelayed(this, ViewConfiguration.getTapTimeout());
        }
            ...
            switch (mMode) {
                ...
                case MODE_TAPPED: {
                    switch (mManagedButton) {
                        case BUTTON_INCREMENT: {
                            if (!mIncrementVirtualButtonPressed) {
                                NumberPickerD.this.postDelayed(this,
